...
class MyRegistrationForm(UserCreationForm):
	...
	username = forms.CharField(label="Username",max_length=30,widget=forms.TextInput(attrs={'class':'form-control','placeholder':'Username should be unique','name':'username'}))
	phone = forms.CharField(label="Phone number",max_length=15,required=True,widget=forms.TextInput(attrs={'class':'form-control','placeholder':'Phone number  e.g 254711222333'}))
